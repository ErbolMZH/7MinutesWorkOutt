...
import com.airo.a7minutesworkout.databinding.ActivityExerciseBinding
import com.airo.a7minutesworkout.databinding.DialogCustomBackConfirmationBinding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private var trainingPlayer: MediaPlayer? = null
...
//    }
    ...
    private fun setupRestView() {
        ...
        try {
            val soundURI =
                Uri.parse("android.resource://com.airo.a7minutesworkout/" + R.raw.press_start)
...
//        try {
//            val soundURI =
//                Uri.parse("android.resource://com.airo.a7minutesworkout/" + R.raw.training)
//            player = MediaPlayer.create(applicationContext, soundURI)
//            player?.isLooping = false
//            player?.start()
//        } catch (e: Exception) {
